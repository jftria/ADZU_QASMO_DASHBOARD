<div class="portal-panel">
    <div class="portal-panel-header">
        <div class="title"><i class="bi bi-droplet"></i> {{ isset($waterBill) ? 'Edit Water Bill' : 'Create Water Bill' }}</div>
    </div>
        ...
        <form method="POST" action="{{ isset($waterBill) ? route('water-bills.update', $waterBill) : route('water-bills.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    @error('reporting_month')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                ...
                <div class="col-12">
                    ...
                    @error('responder_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="col-12"><h6 class="mb-3">Water Bill by Facility (₱)</h6></div>
                ...
                <div class="col-12">
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i> {{ isset($waterBill) ? 'Update' : 'Create' }}</button>
                        <a href="{{ route('water-bills.index') }}" class="btn btn-secondary"><i class="bi bi-x-lg me-1"></i> Cancel</a>
                    </div>
                </div>
            </div>
        </form>
